...
def browser(request):
	...
	if browser_name == "chrome":
		...
		opts = Options()
		opts.add_experimental_option('prefs', {'intl.accept_languages': choose_language})
